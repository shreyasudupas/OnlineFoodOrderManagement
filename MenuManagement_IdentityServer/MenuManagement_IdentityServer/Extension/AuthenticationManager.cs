...
namespace MenuManagement_IdentityServer.Extension
{
    ...
    public static class AuthenticationManagerExtensions
    {
        ...
        /// <returns></returns>
        public static async Task IdentityServer4SignInAsync(this HttpContext context, IdentityServerUser user)
        {
        ...
        /// <returns></returns>
        public static async Task IdentityServer4SignInAsync(this HttpContext context, IdentityServerUser user, AuthenticationProperties properties)
        {
