...
namespace IdenitityServer.Core.Features.Register
{
    ...
    public class RegisterAsVendorCommandHandler : IRequestHandler<RegisterAsVendorCommand, VendorRegister>
    {
        ...
        //    var result = await _idsHttpClientWrapper.PostApiCallAsync("", model, token, "IDSClient");
        ...
        //    var result = await _idsHttpClientWrapper.PostApiCallAsync("", model, token, "VendorClient");
